          ...
          <div>
            ...
            >
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Date of Birth">
                      {getFieldDecorator("dob", {
                        initialValue: data.dob == null ? moment() : moment(data.dob),
                        rules: [
                          {
                            required: true,
                ...
                <Col xs={24} sm={24} md={6} lg={6}>
                  ...
                  >
                    {getFieldDecorator("job_start_date", {
                      initialValue: data.job_start_date == null ? moment() : moment(data.job_start_date),
                      rules: [
                        {
                          required: true,
              ...
              <span style={{ marginLeft: "30%" }}>
                ...
                <Button
                  style={{ borderRadius: "20px", width: "150px", marginLeft: '10%' }}
                  type="add"
                  htmlType="reset"
                >
                  Cancel
