        ...
        >
          ...
          <Card bordered={false}>
            ...
            <Row gutter={24}>
              ...
              <Col xs={24} sm={24} md={6} lg={6}>
                <span style={{ color: "blue" }}>{complainData.fup_no}</span>
              </Col>
            </Row>
            ...
            <Row gutter={24}>
              ...
              <Col xs={24} sm={24} md={6} lg={6}>
                <span style={{ color: "blue" }}>{complainData.model_no}</span>
              </Col>
            </Row>
          </Card>
          ...
          <Card bordered={false}>
            ...
            <Card bordered={true}>
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Warranty :</h3>
                  <p style={{ color: "blue" }}>{complainData.warranty_year} years</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Working Hour :</h3>
                  <p style={{ color: "blue" }}>{complainData.working_hr} hours</p>
                </Col>
              ...
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={12}>
                  ...
                  <p style={{ color: "blue" }}>{complainData.warranty_description}</p>
                </Col>
            ...
            <Card bordered={true}>
              <Row gutter={24}>
                ...
                <Col xs={24} sm={24} md={6} lg={6}>
                  ...
                  <p style={{ color: "blue" }}>{complainData.customer_phone_no}</p>
                </Col>
              ...
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Date :</h3>
                  <p style={{ color: "blue" }}>{moment(complainData.date).format("YYYY/MM/DD")}</p>
                </Col>
