          ...
          <Card bordered={false}>
            ...
            <Card bordered={true}>
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Warranty :</h3>
                  <p>{complainData.warranty_year} years</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Working Hour :</h3>
                  <p>{complainData.working_hr} hours</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Job Title :</h3>
                  <p>{complainData.job_title}</p>
                </Col>
              </Row>
              ...
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={12}>
                  ...
                  <p>{complainData.warranty_description}</p>
                </Col>
            ...
            <Card bordered={true}>
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Customer Name :</h3>
                  <p>{complainData.customer_name}</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Customer Phone No :</h3>
                  <p>{complainData.customer_phone_no}</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Distance :</h3>
                  <p>{complainData.distance} miles</p>
                </Col>
              </Row>
              ...
              <Row gutter={24}>
                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Date :</h3>
                  <p>{moment(complainData.date).format("YYYY/MM/DD")}</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Amount :</h3>
                  <p>{complainData.amount} kyat</p>
                </Col>

                <Col xs={24} sm={24} md={6} lg={6}>
                  <h3>Location :</h3>
                  <p>{complainData.location}</p>
                </Col>
              </Row>
            </Card>
            <h2>
